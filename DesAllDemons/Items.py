...
class ExplosionSprite(pygame.sprite.Sprite):
    ...
    def __init__(self, pos, radius):
        ...
        self.radius = radius
        try:
            self.image = pygame.transform.scale(pygame.image.load("_internal/assert/bomb/explosion.png").convert_alpha(), (radius*2, radius*2))
        except:
...
class Bomb(pygame.sprite.Sprite):
    ...
    def __init__(self, pos):
        ...
        try: 
            self.image = pygame.transform.scale(pygame.image.load("_internal/assert/bomb/bomb.png").convert_alpha(), (self.radius * 2, self.radius * 2))
        except: 
